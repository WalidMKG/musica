    ...
    public class AdminCommentController implements Initializable {
        ...
        @FXML public Label comment_username;
        @FXML public Text comment_text;
        @FXML public MenuButton menu_options;
        ...
        public void setCommentData(Comments comment, Song song) {
            ...
            System.out.println("isAuthorOrPerformer: " + isAuthorOrPerformer);
            ...
            if (menu_options != null) {
                menu_options.setVisible(canManageComment); // Nasconde o mostra il menu a 3 punti
            }
        }
        ...
        // Delega la cancellazione e il refresh a SongPageController
        @FXML
