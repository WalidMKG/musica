        ...
        private void loadComments() {
            ...
            if (song != null) {
                ...
                for (Comments comment : currentComments) {
                    ...
                    try {
                        FXMLLoader loader = new FXMLLoader(getClass().getResource("/univr/musica/fxml/Admin/AdminComment.fxml"));

                        loader.setControllerFactory(clazz -> new AdminCommentController(this.model, this));

                        Node commentNode = loader.load();

                        AdminCommentController commentController = loader.getController();
